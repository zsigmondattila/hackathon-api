...
City.find_or_create_by(name: "Corunca", county: "Mures")
City.find_or_create_by(name: "Sovata", county: "Mures")
City.find_or_create_by(name: "Ciumani", county: "Harghita")
City.find_or_create_by(name: "Gheorgheni", county: "Harghita")
City.find_or_create_by(name: "Cluj Napoca", county: "Cluj")
City.find_or_create_by(name: "Dej", county: "Cluj")
...
Achievement.find_or_create_by(name: "Coupon King/Queen", description: "You reign supreme in the world of coupons! Earn 5 coupons to achieve this noble title.", point_value: 500)
Achievement.find_or_create_by(name: "Coupon Legend", description: "You're a legend among coupon collectors! Earn 10 coupons to achieve this legendary status.", point_value: 1000)
